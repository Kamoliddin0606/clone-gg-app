...
/// Фото ПОСЛЕ (Facing correction) - After photos page
...
class PhotoFacingAfterPage extends StatefulWidget {
  ...
  @override
  State<PhotoFacingAfterPage> createState() => _PhotoFacingAfterPageState();
}

class _PhotoFacingAfterPageState extends State<PhotoFacingAfterPage>
  ...
  Future<void> _saveCapturedPhoto(File imageFile) async {
    try {
      final result = await _photoStorageService.savePhoto(
        ...
        imageFile: imageFile,
        description: 'Facing correction - After',
      );
    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          Text(
            l10n?.photoAfterTitle ?? 'Фото ПОСЛЕ (Facing correction)',
