...
/// Аудит полки (остатки) - Shelf audit page
/// Supports read-only mode for completed steps
class ShelfAuditPage extends StatefulWidget {
  ...
  @override
  State<ShelfAuditPage> createState() => _ShelfAuditPageState();
}

class _ShelfAuditPageState extends State<ShelfAuditPage> {
